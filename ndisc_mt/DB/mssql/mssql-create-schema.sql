...
CREATE DATABASE [ndiscdb]  ON (NAME = N'ndiscdb_Data', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL\data\ndiscdb_Data.MDF' , SIZE = 200, FILEGROWTH = 10%) LOG ON (NAME = N'ndiscdb_Log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL\data\ndiscdb_Log.LDF' , SIZE = 100, FILEGROWTH = 10%)
