-- Add new role 
CREATE ROLE nd_user LOGIN
ENCRYPTED PASSWORD 'nd000'
SUPERUSER INHERIT CREATEDB NOCREATEROLE;

-- Create Database  
CREATE DATABASE "ndisc"
WITH OWNER = nd_user;

-- Create Schema
CREATE SCHEMA nd_user
AUTHORIZATION nd_user;

--- Create Table

CREATE TABLE nd_user."TND_FILE"
(
...
WITH (OIDS=FALSE);
ALTER TABLE nd_user."TND_FILE" OWNER TO nd_user;



CREATE TABLE nd_user."TND_MEDIA"
(
...
WITH (OIDS=FALSE);
ALTER TABLE nd_user."TND_MEDIA" OWNER TO nd_user;



CREATE TABLE nd_user."TND_VOLUME"
(
...
WITH (OIDS=FALSE);
ALTER TABLE nd_user."TND_VOLUME" OWNER TO nd_user;



CREATE TABLE nd_user."TND_QUEUE"
(
...
WITH (OIDS=FALSE);
ALTER TABLE nd_user."TND_QUEUE" OWNER TO nd_user;



CREATE TABLE nd_user."TND_STAT"
(
...
WITH (OIDS=FALSE);
ALTER TABLE nd_user."TND_STAT" OWNER TO nd_user;
