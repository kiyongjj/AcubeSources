...
<%
	...
	String doc = new String(lm_doc.getBytes("8859_1"), "EUC-KR");
	String lm_runvar = request.getParameter("runvar");
	String runvar;
	if (lm_runvar != null)
		runvar = new String(lm_runvar.getBytes("8859_1"), "EUC-KR"); 
	else
		runvar = new String();
%>
<HTML>
...
function OnRun()
{
	...
	else
	{
		try
		{
		    oReport = RQViewer.OpenReport("<%=basePath%>document/getreport_get.jsp?doc=" + docName);
		} catch(err)
		{
			return;
		}			
	...
	//RQViewer.SetDocLinkJSP("rqviewerlink_euckr.jsp");	
