...
<!-- ] Hyper Link(문서연결)을 위해 반드시 있어야 하는 부분 -->
<script language="javaScript" SRC="<%=basePath%>setup/rqviewer_api.js"></script>
<script language=JavaScript>
  IE_Viewer_Change(800,400);
</script>
<br><br>
<input type='button' value='SaveAsDialog("")' onclick='RQViewer.SaveAsDialog("")'/>
<input type='button' value='SaveAsDialog("User Docname")' onclick='RQViewer.SaveAsDialog("User Docname")'/>
<input type='button' value='SaveAsDialog("EMPTY")' onclick='RQViewer.SaveAsDialog("EMPTY")'/>
</BODY>
</HTML>
