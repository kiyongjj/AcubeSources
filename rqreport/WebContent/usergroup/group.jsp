        ...
        <tr>
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="8"></td>
              <td align="left"><a href="user.jsp" class="menuon">사용자/그룹관리</a></td>
            </tr>
          </table>
		  </td>
        </tr>
        ...
        <tr>
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="right" width="25"><img src="../img/menu_dot.gif"></td>
              <td width="8"></td>
              <td align="left"><a href="../db/db.jsp" class="menuoff">DB관리</a></td>
            </tr>
          </table>
		  </td>
        </tr>
        ...
        <tr>
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="right" width="25"><img src="../img/menu_dot.gif"></td>
              <td width="8"></td>
              <td align="left"><a href="../environment/environment.jsp" class="menuoff">설치관리</a></td>
            </tr>
          </table>
		  </td>
        </tr>
        		...
        		<tr>
          			<td height="23" bgcolor="56729E" onMouseOver="this.style.backgroundColor='#4D5C87'" onMouseOut="this.style.backgroundColor=''" style=cursor:hand; >
            			...
            			<tr>
              				<td align="right" width="25"><img src="../img/menu_dot.gif"></td>
              				<td width="8"></td>
              				<td align="left"><a href="../environment/rqenv.jsp" class="menuoff">환경변수</a></td>
            			</tr>
          				</table>
		  			</td>
        		</tr>
			  ...
			  <tr>
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<td><span class="title">사용자/그룹관리</span></td>					  </tr>
					</table>
				</td>
			  </tr>
			  <tr>
				...
				<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr> 
					  <td align="center"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr> 
							<td height="2" colspan="7" bgcolor="#A8CC72"></td>
						  </tr>
						  <tr class="table_title"> 
							<td width="50" height="26" class="stitle"><input type="checkbox" name="checkbox" value="checkbox"> 
							</td>
							...
							<td class="table_title">설명</td>
						  </tr>
						  <tr> 
							<td height="1" colspan="7" bgcolor="#A8CC72"></td>
						  </tr>
						  <tr> 
							<td class="text"><input type="checkbox" name="checkbox2" value="checkbox"></td>
							<td width="1"></td>
							<td bgcolor="#FFFFFF" class="text" style="font-family: verdana;"><img src="../img/icon_group.gif" hspace="5">administrator</td>
							<td width="1"></td>
							<td bgcolor="#FFFFFF" class="text" style="font-family: verdana;">administrator</td>
							<td width="1"></td>
							<td bgcolor="#FFFFFF" class="text" style="font-family: verdana;">Administrator Group</td>
						  </tr>
						  <tr> 
									  ...
									  <tr> 
										...
										<table border="0" align="left" cellpadding="0" cellspacing="0">
											<tr> 
											  ...
											  <td background="../img/btn_w_bg.gif" class="btn_text_td"><a href="group.jsp" class="btn_white">그룹편집</a></td>
									  ...
									  <tr> 
										<td> <table border="0" cellspacing="0" cellpadding="0">
											<tr> 
											  ...
											  <td background="../img/btn_g_bg.gif"><img src="../img/icon_group_regis.gif" width="20" height="14" hspace="6"></td>
											  <td background="../img/btn_g_bg.gif" class="btn_text_td"><a href="#" class="btn_green" onClick="MM_openBrWindow('newgroup.jsp','','width=330,height=263')">새 그룹 등록</a></td>
