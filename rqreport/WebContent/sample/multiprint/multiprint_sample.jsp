...
function make_innerHTML() {
	...
	document.all.innertxt.innerHTML += "<input type='hidden' name='doc' value='/multiprint/RQReport2.rqx'> ";
...
function winPrint() {
	...
	document.winFile.action="rqviewer_bulkprint.jsp";
...
function saveRQVs() {
	...
	document.winFile.excel_flag.value="false"; 
	document.winFile.print_flag.value="false";
	document.winFile.pdf_flag.value="false";
	document.winFile.rqv_flag.value="save";
...
<tr>
	<td>RQV저장</td>
	<td>
		<a href="javascript:saveRQVs('save')" >RQV저장</a>
	</td>
</tr>
<tr>
	<td>저장 경로</td>
...
<input type="hidden" name="rqv_flag" />
</form>
